...
#install cf
wget https://raw.githubusercontent.com/${GitUser}/hasilsenip/main/install/cf.sh && chmod +x cf.sh && ./cf.sh
rm -f /root/cf.sh
clear
else
...
sleep 1
wget https://raw.githubusercontent.com/${GitUser}/hasilsenip/main/install/ssh-vpn.sh && chmod +x ssh-vpn.sh && screen -S ssh-vpn ./ssh-vpn.sh
echo -e "\e[0;32mDONE INSTALLING SSH & OVPN\e[0m"
clear
#install Xray
echo -e "\e[0;32mINSTALLING XRAY CORE...\e[0m"
sleep 1
wget https://raw.githubusercontent.com/${GitUser}/hasilsenip/main/install/ins-xray.sh && chmod +x ins-xray.sh && screen -S ins-xray ./ins-xray.sh
...
wget https://raw.githubusercontent.com/${GitUser}/hasilsenip/main/websocket-python/websocket.sh && chmod +x websocket.sh && screen -S websocket.sh ./websocket.sh
echo -e "\e[0;32mDONE INSTALLING WEBSOCKET PORT\e[0m"
clear
#install SET-BR
echo -e "\e[0;32mINSTALLING SET-BR...\e[0m"
sleep 1
wget https://raw.githubusercontent.com/${GitUser}/hasilsenip/main/install/set-br.sh && chmod +x set-br.sh && ./set-br.sh
...
echo -e "    \e[1;32m|         PREMIUM BY AQUAGURL          |\e[0m"
echo -e "    \e[1;32m'------------------------------------------'\e[0m"
echo ""
